...
namespace PureMVC
{
    namespace Patterns
    {
...
#else
            typedef std::shared_ptr<IAggregate<std::string> > CoreNames;
#endif
        public:
        ...
        public:
             ...
             */
            virtual void notifyObservers(Interfaces::INotification const& notification);
             ...
             * @param notification the <code>INotification</code> to have the <code>View</code> notify <code>Observers</code> of.
             */
            static void broadcastNotification(Interfaces::INotification const& notification);
