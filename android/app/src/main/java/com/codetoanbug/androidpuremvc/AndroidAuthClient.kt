...
class AndroidAuthClient(
    ...
    private val handle: Long = nativeCreate(host, port, mock, storage)
    ...
    private external fun nativeCreate(host: String, port: Int, mock: Boolean, storage: SecureStorage): Long
